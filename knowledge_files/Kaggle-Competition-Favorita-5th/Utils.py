...
def train_generator(df, promo_df, items, stores, timesteps, first_pred_start,
    ...
    while 1:
        date_part = np.random.permutation(range(n_range))#随机乱序
